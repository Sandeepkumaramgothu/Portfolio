  ...
  return (
    <section id="experience" className="py-20 bg-slate-800/50">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-16 text-center">Professional Experience</h2>
          ...
          {EXPERIENCE.map((exp, index) => (
            <div key={index} className={`relative flex flex-col md:flex-row gap-8 mb-16 ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
              ...
              <div className="ml-16 md:ml-0 md:w-1/2">
                <div className={`bg-slate-900 p-6 rounded-xl border border-slate-700 shadow-lg ${index % 2 === 0 ? 'md:mr-12' : 'md:ml-12'}`}>
